...
class AVLTree {
    ...
    private void balancear(int i) {
        ...
        if (fe > 1) {
            ...
            if (obtenerFactorEquilibrio(hijoIzq) >= 0) {
                System.out.println("-> Rotación Simple Derecha ejecutada en índice: " + i + " (ID: " + ids[i] + ")");
                rotacionDerecha(i);
            } else {
                System.out.println("-> Rotación Doble Izquierda-Derecha ejecutada en índice: " + i + " (ID: " + ids[i] + ")");
            ...
            if (obtenerFactorEquilibrio(hijoDer) <= 0) {
                System.out.println("-> Rotación Simple Izquierda ejecutada en índice: " + i + " (ID: " + ids[i] + ")");
                rotacionIzquierda(i);
            } else {
                System.out.println("-> Rotación Doble Derecha-Izquierda ejecutada en índice: " + i + " (ID: " + ids[i] + ")");
    ...
    public void eliminar(int id) {
        System.out.println("Intentando eliminar clave: " + id);
        eliminarRec(0, id);
    }
