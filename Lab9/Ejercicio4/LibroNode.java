...
public class LibroNode<T extends Comparable<T>> {
    private static int idCounter = 0;
    protected int idNode;
    protected LibroNode<T> parent;
    protected ArrayList<T> keys;
    protected ArrayList<LibroNode<T>> childs;
    protected int count;
    protected int maxKeys;

    public LibroNode(int n) {
    ...
    public void setChild(int index, LibroNode<T> child) {
    ...
    public boolean nodeFull() { return this.count == maxKeys; }
